...
public class WSFE{
    ...
    public static void main(String[] args) throws UnsupportedLookAndFeelException {
        ...
        Cliente c = new Cliente(39952, 555555, "RI", "Gabriel", "Barrientos");
        DomicilioCli d1 = new DomicilioCli("Monteagudo",747);
        c.agregarDireccion(d1);
        UIManager.setLookAndFeel(new UpperEssentialLookAndFeel());   
        ventanaSplash v = new ventanaSplash();
        v.setVisible(true);
